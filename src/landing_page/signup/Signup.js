    ...
    return (
        <div className="auth-shell">
            ...
            <div className="auth-container">
                <div
                    className={`auth-panel ${errorEffect ? "auth-error" : ""} ${successEffect ? "auth-success" : ""}`}
                >
                    <div className="auth-badge">Z</div>

                    <h2>Create your account</h2>
                    <p className="auth-subtitle">
                        Start trading with a clean and simple dashboard
                    </p>

                    {message && (
                        <div className={`auth-alert ${successEffect ? "success" : "error"}`}>
                            {message}
                        </div>
                    )}
            ...
            <style>{`
                ...
                .auth-badge {
                    ...
                    justify-content: center;
                    align-items: center;
                    background: linear-gradient(135deg, #387ed1, #6ba7ff);
                    color: white;
                    font-size: 26px;
                    font-weight: 700;
                ...
                .auth-success {
                    animation: successLift 1.1s ease forwards;
                }
                ...
                @keyframes softPop {
                    0% {
                        opacity: 0;
                        transform: translateY(80px) rotateX(30deg) scale(0.85);
                    }
                    100% {
                        opacity: 1;
